...
**Weak locking** ($\Lambda_{lock} \ll 1$): Formation energy dominates. Structures appear easily but decay quickly.
Examples:
- Linear waves
- Weak coherent packets

**Balanced locking** ($\Lambda_{lock} \sim 1$): Formation and stabilization energies are comparable.
Examples:
- Vortices
- Vortex rings

**Strong locking** ($\Lambda_{lock} \gg 1$): Stabilization energy dominates.
Examples:
- Shells
- Braid structures
