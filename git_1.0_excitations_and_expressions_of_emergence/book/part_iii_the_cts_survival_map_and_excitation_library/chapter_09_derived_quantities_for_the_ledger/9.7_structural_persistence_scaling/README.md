...
Let the excitation have characteristic size
$$
L.
$$
...
where
$$
$\rho$ is structural energy density
$$
(d) is the effective dimensionality of the structure.
...
where
$$
$\gamma$ represents environmental coupling strength.
$$
...
S_* =
\mathcal{E}{shell}\mathcal{E}D T{obj}
\frac{\rho L^d}{\gamma L^{d-1} t_{ref}}.
$$
Simplifying yields
$$
\boxed{
...
Topology modifies persistence scaling through the factor
$$
T_{obj}.
$$
...
Shell structures receive an additional persistence multiplier
$$
\mathcal{E}_{shell}.
$$
...
Substituting the persistence scaling into the survival condition
$$
xy = 1
$$
gives
...
Abundance Law
This final section derives how excitation populations emerge from the combined effects of formation energy and persistence.
