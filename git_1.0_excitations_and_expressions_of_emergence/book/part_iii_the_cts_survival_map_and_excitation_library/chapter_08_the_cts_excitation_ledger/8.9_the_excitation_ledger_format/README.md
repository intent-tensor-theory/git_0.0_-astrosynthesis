...
Each excitation also possesses a characteristic spatial scale $L_*$.
...
The ledger reveals an important principle: structures that are cheap to form dominate the background, while structures that are strongly locked dominate persistence.
