...
For symmetric shell structures
$$
N = 6
$$
corresponding to the six-fan configuration.
...
k_1 , k_2
$$
represent the principal curvatures of the shell surface.
...
Shells possess surface tension
$$
\sigma.
$$
...
N_f
$$
represent the number of fan channels.
...
Define the phase of each channel
$$
\phi_i.
$$
...
composite object
shell
multi-channel persistent structure
...
Deriving the Topology Factor
This section derives a mathematical factor representing the contribution of topological constraints to structural persistence.
