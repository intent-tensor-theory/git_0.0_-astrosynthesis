...
\mathbf{F}
$$
represents the dynamical flow vector.
...
To incorporate this effect into persistence mechanics we define the drift stability factor
$$
D.
$$
...
The system can be visualized as moving through a stability landscape defined by the structural energy
$$
E(\mathbf{q}).
$$
...
This effect is captured by the drift stability factor
$$
D.
$$
...
Six-Fan Lock Logic and Shell Admissibility
This section derives the geometric locking conditions required for multi-channel structural stability.
