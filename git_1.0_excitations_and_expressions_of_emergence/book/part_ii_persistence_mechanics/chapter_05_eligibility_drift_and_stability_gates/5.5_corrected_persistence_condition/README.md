...
This restriction is enforced through the eligibility operator $\mathcal{E}(\sigma)$.
...
To account for this effect we introduce the drift stability factor $D$.
...
Define a shell admissibility operator $\mathcal{E}_{shell}$.
